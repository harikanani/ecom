    ...
    <div class="product-view-inner">
        <div class="product-view-left">
            <div class="product-view-image">
              <a href="/products/<?php echo $row['limg'];?>"><img class="view-image" src="<?php echo $row['limg'];?>" /></a> 
            </div>
            ...
            <div class="order-outer">
                ...
                <a href="https://api.whatsapp.com/send?phone=919876543210&text=Hello,I am intrested in buying your product <?php echo $row['lcode']." ".$row['lname'];?>" target="_blank"> <button class="order-button">BUY NOW</button></a>
                </div>
            </div>
        </div>
